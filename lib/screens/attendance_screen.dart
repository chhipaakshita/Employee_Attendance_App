        ...
        child: Column(
          children: [
            Container(
              ...
              child: Text(
                "WELCOME",style: TextStyle(color: Colors.black54,fontSize: 30),
              ),
            ),
            Consumer<DbService>(builder: (context,dbService,child){
              return FutureBuilder(future: dbService.getUserData(),
                  builder: (context,snapshot){
                      if(snapshot.hasData){
                        UserModel user = snapshot.data!;
                        return Container(
                          alignment: Alignment.centerLeft,
                          child: Text(user.name !=''? user.name: "#${user.employeeId}",
                            style: TextStyle(fontSize: 25),),
                        );
                      }
                      return SizedBox(width: 60, child: LinearProgressIndicator(),);
                  });
            }),
            ...
            Container(
              alignment: Alignment.centerLeft,
              margin: EdgeInsets.only(top:32),
              child: Text("Today's Status",style: TextStyle(fontSize: 25),),
            ),
            Container(
                ...
                children: [
                  ...
                  Expanded(child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(width: 80,child: Divider(),),
                      Text(attendanceService.attendanceModel?.check_out ?? '--/--',style: TextStyle(fontSize: 25),)
                    ],
                  ))
                ],
              ),
            ...
            Container(
              ...
              child: Builder(builder: (context){
                return SlideAction(
                  ...
                  "Slide to Check In":"Slide to Check Out",
                  textStyle: TextStyle(
